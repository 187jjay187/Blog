...
RSpec.describe 'User Index', type: :feature do
  ...
  it 'should have the photo of each user' do
    assert page.has_xpath?("//img[@src = 'https://cdn-icons-png.flaticon.com/512/4140/4140048.png'
    and @alt = 'user photo']")
    assert page.has_xpath?("//img[@src = 'https://cdn-icons-png.flaticon.com/512/9461/9461667.png'
    and @alt = 'user photo']")
  end
