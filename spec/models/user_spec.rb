...
RSpec.describe User, type: :model do
  before :each do
    @user = User.new(name: 'Jerome', photo: 'https://unsplash.com/photos/XUdIi04ohps', bio: 'Student')
  end
  ...
  describe 'methods' do
    before do
      @user1 = User.create(name: 'Jerome', photo: 'https://unsplash.com/photos/XUdIi04ohps', bio: 'Student')
      5.times do
